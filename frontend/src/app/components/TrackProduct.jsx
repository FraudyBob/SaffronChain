...
export function TrackProduct({ onClose }) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm text-gray-600 dark:text-gray-400">Turmeric Origin</p>
                        <p className="font-semibold text-gray-900 dark:text-white">{product.turmeric_origin}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <p className="font-semibold text-gray-900 dark:text-white">{formatDate(product.harvest_date)}</p>
                      </div>
                    </div>
